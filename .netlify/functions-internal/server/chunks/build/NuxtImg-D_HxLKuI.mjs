...
import { v as defu, y as withLeadingSlash, j as hasProtocol, l as joinURL, z as parseURL, A as encodeParam, B as encodePath } from '../nitro/nitro.mjs';
import { k as useHead, g as useNuxtApp, j as useRuntimeConfig } from './server.mjs';
...
const ipxRuntime$TwWTPRiDyKl5tgozuZoTuOomJGFqudpPeJosGusv2Rk = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$TwWTPRiDyKl5tgozuZoTuOomJGFqudpPeJosGusv2Rk, defaults: {} }
  }
};
...
export { __nuxt_component_1 as _, useRequestFetch as u };
//# sourceMappingURL=NuxtImg-D_HxLKuI.mjs.map
